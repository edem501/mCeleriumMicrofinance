...
namespace iCelerium.Controllers
{
    public class HoTosController : Controller
    {
        ...
        public ActionResult MultipleCharts()
        {
            ...
            return this.View(new Container(new[] { chart1, chart2, chart3, chart4 }));
        }
        ...
        public ActionResult BindDataFromDictionary()
        {
            ...
            return this.View(chart1);
        }

        public ActionResult BindDataFromObjectList()
        {
            List<DataClass1> data = new List<DataClass1>
            {
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-10).Date, ExecutionValue = 20.21 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-9).Date, ExecutionValue = 23.13 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-8).Date, ExecutionValue = 27.41 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-7).Date, ExecutionValue = 30.51 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-6).Date, ExecutionValue = 21.16 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-5).Date, ExecutionValue = 22.17 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-4).Date, ExecutionValue = 33.18 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-3).Date, ExecutionValue = 34.91 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-2).Date, ExecutionValue = 40.10 },
                new DataClass1 { ExecutionDate = DateTime.Now.AddDays(-1).Date, ExecutionValue = 50.11 },
                new DataClass1 { ExecutionDate = DateTime.Now.Date, ExecutionValue = 20.1 },
            };
            object[,] chartData = new object[data.Count, 2];
            int i = 0;
            foreach (DataClass1 item in data)
            {
